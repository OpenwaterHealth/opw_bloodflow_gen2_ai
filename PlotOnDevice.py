...
class ReadGen2Data:
    ...
    def ReadHistogram(self, histogramPath):
        ...
        histogramData = histogramData.reshape((histogramnp.shape[0]//(self.numBinsHist+4),self.numBinsHist+4))
        ...
        histogramData1 = histogramData1.reshape((histogramnp.shape[0]//(self.numBinsHist+4),self.numBinsHist+4))
        ...
        finalCamTemp = camTemps[-1] # grab the final camera temperature'''
        finalCamTemp = 0
...
def generate_plot(filepath, scanPos, display=False):  
    dt = 1./40
    ...
    for i in range(0,6):
        ...
        ax1 = plt.subplot(3, 2, pltInds[i]+1)
        ax2 = ax1.twinx()
...
if __name__ == "__main__":
    ...
    if args.scanPath is None:
        args.scanPath = '/Users/kedar/Downloads/SCAN_6C_2023_10_05_112732/FULLSCAN_6C_2023_10_05_112732/'
